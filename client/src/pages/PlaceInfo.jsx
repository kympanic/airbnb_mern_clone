...
const PlaceInfo = () => {
	...
	if (showAllPhotos) {
		return (
			<div className="absolute inset-0 text-white min-h-screen bg-black ">
				<div className="p-8 grid gap-4 bg-black">
					<div>
						<h2 className=" mr-36 text-3xl">
		...
		<div className="mt-4 bg-gray-100 px-8 pt-8">
			...
			<div className="relative">
				...
				<button
					...
					className=" flex gap-1 absolute bottom-2 right-2 cursor-pointer py-2 px-4 bg-white rounded-2xl shadow shadow-md shadow-gray-500"
				>
					<svg
						xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 24 24"
			...
			<div className="mt-8 bg-white -mx-8 px-8 py-8 border-t">
